...
var DaishWriter = /** @class */ (function (_super) {
    __extends(DaishWriter, _super);
    function DaishWriter(struct) {
    ...
    return DaishWriter;
}(pollenium_toadflax_1.TokenWriter));
exports.DaishWriter = DaishWriter;
